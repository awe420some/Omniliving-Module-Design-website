    ...
    <g style={{ transform: `translate(${offsetX * 0.6}px, ${offsetY * 0.6}px)`, transition: 'transform 0.1s ease-out' }}>
      {module.id === 'wohnen' && (
        <>
          ...
          <rect x="10" y="35" width="15" height="10" rx="0.5" fill={isNight ? '#3E6151' : '#3E6151'} stroke={module.accentColor} strokeWidth="0.3" opacity={ambientLight} />
          ...
          {isNight && <circle cx="5.5" cy="30" r="3" fill="rgba(195, 248, 189,0.06)" />}
        </>
      )}
      {module.id === 'schlafen' && (
        <>
          ...
          {/* Wall art */}
          <rect x="30" y="18" width="8" height="6" rx="0.3" fill={isNight ? '#3E6151' : '#2a2a3e'} stroke={module.accentColor} strokeWidth="0.15" opacity="0.5" />
      ...
      {module.id === 'kueche' && (
        <>
          ...
          <rect x="62" y="25" width="12" height="40" rx="0.5" fill={isNight ? '#3E6151' : '#e0e0e0'} stroke={module.accentColor} strokeWidth="0.3" opacity="0.8" />
          <line x1="62" y1="40" x2="74" y2="40" stroke={module.accentColor} strokeWidth="0.2" opacity="0.3" />
          <rect x="64" y="27" width="8" height="11" rx="0.2" fill={isNight ? '#1E3429' : '#888'} opacity="0.5" />
          {/* Fridge handle */}
          ...
          {isNight && (
            <>
              <rect x="8" y="22" width="42" height="0.5" fill="rgba(195, 248, 189,0.15)" />
              <rect x="8" y="22" width="42" height="6" fill="rgba(195, 248, 189,0.03)" />
            </>
          )}
      ...
      {module.id === 'bad' && (
        <>
          ...
          <rect x="68" y="55" width="10" height="12" rx="2" fill={isNight ? '#3E6151' : '#f0f0f0'} stroke={module.accentColor} strokeWidth="0.3" opacity="0.8" />
          <rect x="70" y="58" width="6" height="6" rx="1.5" fill={isNight ? '#1E3429' : '#ddd'} />
          {/* Toilet tank */}
          <rect x="68" y="52" width="10" height="4" rx="0.5" fill={isNight ? '#3E6151' : '#e8e8e8'} stroke={module.accentColor} strokeWidth="0.2" opacity="0.6" />

          {/* Washing machine with shadow */}
          <rect x="16" y="64" width="12" height="12" rx="0.5" fill="rgba(0,0,0,0.1)" />
          <rect x="15" y="62" width="12" height="12" rx="0.5" fill={isNight ? '#3E6151' : '#e8e8e8'} stroke={module.accentColor} strokeWidth="0.3" opacity="0.7" />
          <circle cx="21" cy="68" r="3.5" fill={isNight ? '#1E3429' : '#ccc'} />
          <circle cx="21" cy="68" r="1.5" fill={isNight ? '#3E6151' : '#ddd'} opacity="0.5" />

          {/* Mirror with frame */}
          <rect x="42" y="14" width="26" height="15" rx="0.5" fill={isNight ? '#1E3429' : 'rgba(200,220,240,0.2)'} stroke={module.accentColor} strokeWidth="0.3" opacity="0.5" />
    ...
    <g style={{ transform: `translate(${offsetX * 1}px, ${offsetY * 0.8}px)`, transition: 'transform 0.08s ease-out' }}>
      {module.id === 'wohnen' && (
        <>
          ...
          {/* Sofa */}
          <rect x="20" y="50" width="30" height="18" rx="1.5" fill={isNight ? '#3E6151' : '#2a3a4e'} stroke={module.accentColor} strokeWidth="0.3" opacity={ambientLight} />
          <rect x="20" y="48" width="6" height="20" rx="1" fill={isNight ? '#3E6151' : '#2a3a4e'} stroke={module.accentColor} strokeWidth="0.2" opacity={ambientLight} />
          {/* Cushions */}
          ...
          {/* Coffee table */}
          <rect x="28" y="42" width="14" height="6" rx="0.5" fill={isNight ? '#3E6151' : '#3a2a1e'} stroke={module.accentColor} strokeWidth="0.3" opacity={ambientLight} />
          ...
          <path d="M50 42 Q52.5 38 55 42" fill={isNight ? 'rgba(195, 248, 189,0.2)' : 'rgba(255,255,240,0.3)'} stroke={module.accentColor} strokeWidth="0.2" opacity="0.4" />
          {isNight && <circle cx="52.5" cy="40" r="4" fill="rgba(195, 248, 189,0.06)" />}
        </>
      )}
      {module.id === 'schlafen' && (
        <>
          ...
          {/* Double bed */}
          <rect x="15" y="48" width="40" height="20" rx="1" fill={isNight ? '#3E6151' : '#2a2a3e'} stroke={module.accentColor} strokeWidth="0.3" opacity={ambientLight} />
          {/* Headboard */}
          ...
          <rect x="16" y="62" width="38" height="5" rx="0.5" fill={isNight ? '#3E6151' : '#ddd8cc'} opacity="0.3" />
          ...
          <rect x="10" y="48" width="2" height="2.5" rx="0.3" fill={isNight ? 'rgba(195, 248, 189,0.4)' : module.accentColor} opacity="0.5" />
          <path d="M9 48 Q11 45.5 13 48" fill={isNight ? 'rgba(195, 248, 189,0.2)' : 'rgba(255,255,240,0.3)'} opacity="0.5" />
          {isNight && <circle cx="11" cy="46" r="3" fill="rgba(195, 248, 189,0.06)" />}
      ...
      {module.id === 'kueche' && (
        <>
          ...
          {/* L-shaped counter */}
          <rect x="8" y="38" width="42" height="8" rx="0.3" fill={isNight ? '#3E6151' : '#3a3a4e'} stroke={module.accentColor} strokeWidth="0.3" opacity={ambientLight} />
          <rect x="8" y="38" width="8" height="28" rx="0.3" fill={isNight ? '#3E6151' : '#3a3a4e'} stroke={module.accentColor} strokeWidth="0.3" opacity={ambientLight} />
          {/* Counter top */}
          <rect x="8" y="36" width="42" height="3" rx="0.2" fill={isNight ? '#1a1e2a' : '#888'} stroke={module.accentColor} strokeWidth="0.2" opacity="0.6" />
          {/* Stove */}
          <circle cx="25" cy="37.5" r="1.2" fill={isNight ? '#C3F8BD' : '#666'} opacity="0.6" />
          <circle cx="30" cy="37.5" r="1.2" fill={isNight ? '#C3F8BD' : '#666'} opacity="0.6" />
          <circle cx="25" cy="33.5" r="1" fill={isNight ? 'rgba(195, 248, 189,0.4)' : '#555'} opacity="0.4" />
          <circle cx="30" cy="33.5" r="1" fill={isNight ? 'rgba(195, 248, 189,0.4)' : '#555'} opacity="0.4" />
          {/* Coffee machine */}
          ...
          {/* Bar stools */}
          <circle cx="35" cy="62" r="3" fill={isNight ? '#3E6151' : '#4a4a5e'} stroke={module.accentColor} strokeWidth="0.3" opacity="0.6" />
          <line x1="35" y1="65" x2="35" y2="68" stroke={module.accentColor} strokeWidth="0.3" opacity="0.3" />
          <circle cx="45" cy="62" r="3" fill={isNight ? '#3E6151' : '#4a4a5e'} stroke={module.accentColor} strokeWidth="0.3" opacity="0.6" />
          <line x1="45" y1="65" x2="45" y2="68" stroke={module.accentColor} strokeWidth="0.3" opacity="0.3" />

          {/* Sink */}
          <ellipse cx="18" cy="37" rx="3" ry="1.5" fill={isNight ? '#1E3429' : '#aaa'} opacity="0.5" />
          {/* Faucet */}
      ...
      {module.id === 'bad' && (
        <>
          ...
          {/* Walk-in shower */}
          <rect x="8" y="25" width="22" height="32" rx="0.5" fill={isNight ? '#1E3429' : '#e8f4f8'} stroke={module.accentColor} strokeWidth="0.3" opacity={ambientLight} />
          <rect x="8" y="25" width="22" height="32" rx="0.5" fill="none" stroke="rgba(200,220,240,0.3)" strokeWidth="0.5" />
          {/* Shower head */}
          <circle cx="19" cy="30" r="2" fill={isNight ? '#3E6151' : '#ccc'} stroke={module.accentColor} strokeWidth="0.2" />
          {/* Shower water drops */}
          <g opacity="0.15">
          ...
          {/* Double vanity */}
          <rect x="40" y="30" width="30" height="12" rx="0.5" fill={isNight ? '#3E6151' : '#f0f0f0'} stroke={module.accentColor} strokeWidth="0.3" opacity={ambientLight} />
          {/* Sinks */}
          <ellipse cx="50" cy="36" rx="4" ry="2.5" fill={isNight ? '#1E3429' : '#ddd'} />
          <ellipse cx="62" cy="36" rx="4" ry="2.5" fill={isNight ? '#1E3429' : '#ddd'} />
          {/* Faucets */}
  ...
  return (
    <g>
      {moduleLamps.map((lamp, i) => (
        <g key={`lamp-${i}`}>
          <circle cx={lamp.x} cy={lamp.y} r="20" fill="rgba(195, 248, 189, 0.06)" />
          <circle cx={lamp.x} cy={lamp.y} r="12" fill="rgba(195, 248, 189, 0.08)" />
          <circle cx={lamp.x} cy={lamp.y} r="6" fill="rgba(195, 248, 189, 0.07)" />
          <circle cx={lamp.x} cy={lamp.y} r="2" fill="rgba(195, 248, 189, 0.15)" />
        </g>
      ))}
              ...
              <div className="flex items-center gap-3">
                ...
                <motion.button
                  ...
                  animate={{
                    ...
                    borderColor: isNight ? 'rgba(195, 248, 189,0.3)' : 'rgba(255,255,255,0.1)',
                    color: isNight ? '#C3F8BD' : '#D4C5A0',
                  }}
              ...
              >
                ...
                >
                  ...
                  >
                      ...
                      return (
                        <g key={hotspot.id}>
                          ...
                          <circle
                            ...
                            fill={isHovered || isSelected ? currentModule.accentColor : 'rgba(195, 248, 189, 0.5)'}
                            stroke={currentModule.accentColor}
                            strokeWidth="0.3"
                    ...
                    {/* Room label */}
                    <text x="50" y="95" textAnchor="middle" fill="#D4C5A0" fontSize="2.5" fontFamily="system-ui" opacity="0.3">
                ...
                >
                  ...
                  >
                    <svg width="20" height="14" viewBox="0 0 20 14" fill="none" className="opacity-40">
                      <path d="M3 7 C5 3, 8 1, 10 1 C12 1, 15 3, 17 7" stroke="#C3F8BD" strokeWidth="0.8" fill="none" />
                      <path d="M17 7 C15 11, 12 13, 10 13 C8 13, 5 11, 3 7" stroke="#C3F8BD" strokeWidth="0.8" fill="none" strokeDasharray="2 1" />
                      <circle cx="10" cy="7" r="1" fill="#C3F8BD" opacity="0.5" />
                    </svg>
                  </motion.div>
